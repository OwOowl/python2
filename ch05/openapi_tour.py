...
serviceKey = 'yUC%2FElU1%2FvOjuV00HbEj%2BFQYbny5Pxlft10taW5jtb8N4mH5xCT0aTy0SUSOwJ%2BwdjRtLjnN%2Frgbw%2BLFbcfZYg%3D%3D'
...
def main():
    ...
    if natName == '':
        ...
        result_df.to_csv('./data/%s_%s_%d_%s.json' % (natName, ed, nStartYear, dataEND), index=False, encoding='cp949')
